...
## We'll check the accuracy of each and every model and select the best one for our use case
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            model_report: dict = evaluate_models(X_train=X_train, y_train=y_train, X_test=X_test, y_test=
